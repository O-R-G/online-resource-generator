export class customGraphicStatic{
    ...
    renderAddCustomGraphicButton() {
        ...
        this.elements.positionX.placeholder = 'X (0)';
        ...
        this.elements.positionY.placeholder = 'Y (0)';
    ...
    updatePosition(){
        this.position.x = this.elements.positionX.value ? parseFloat(this.elements.positionX.value) * this.canvasObj.scale : this.position.x;
        this.position.y = this.elements.positionY.value ? parseFloat(this.elements.positionY.value) * this.canvasObj.scale : this.position.y;
        this.canvasObj.draw();
    }
    draw(){
        this.context.save();
        this.context.fillStyle = this.shape.textColor;
